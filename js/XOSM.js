...
//minerva.ual.es:8984/rest devuelve la lista de BD creadas en BaseX 
...
$('document').ready (
    ...
    $(document).on( 'shown.bs.tab', 'a[data-toggle="tab"]', function (e) {
     ...
     $('#runXQueryShellbtn').click(function() {
      ...
      function databaseListing(){
       ...
       var url = 'http://minerva.ual.es:8984/rest/appSetup/appSetup.xml';
  ...
  function runningXQueryShell(){
    ...
    var url = 'http://minerva.ual.es:8984/rest?run=runningXQueryEval.xq&textArea=' + encodeURIComponent($text); 
